...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    const apiUrl = "https://server.payuee.com/profile";
    ...
    if (!SHOW_EDIT) {
        ...
        if (firstName !== firstNameBox || lastName !== lastNameBox || address !== addressBox) {
                ...
                const details = {
                  ...
                  const apiUrl = "https://server.payuee.com/profile/update";
...
document.getElementById('referral_link').addEventListener('click', function (event) {
    ...
    navigator.clipboard.writeText('https://server.payuee.com/page/signup-new?referral-code=' + ReferralCode)
    .then(() => {
        // Success
        referralLinkCopier();
        console.log('success');
...
//     const apiUrl = 'https://server.payuee.com/link-whatsapp/' + whatsappNumber;
...
//     const url = 'https://server.payuee.com/verify-whatsapp';
//     try {
