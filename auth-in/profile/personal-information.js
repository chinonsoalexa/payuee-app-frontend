...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    const apiUrl = "https://payuee-avev.onrender.com/profile";
    ...
    if (!SHOW_EDIT) {
        ...
        if (firstName !== firstNameBox || lastName !== lastNameBox || address !== addressBox) {
                ...
                const details = {
                  ...
                  const apiUrl = "https://payuee-avev.onrender.com/profile/update";
...
//     const apiUrl = 'https://payuee-avev.onrender.com/link-whatsapp/' + whatsappNumber;
...
//     const url = 'https://payuee-avev.onrender.com/verify-whatsapp';
//     try {
