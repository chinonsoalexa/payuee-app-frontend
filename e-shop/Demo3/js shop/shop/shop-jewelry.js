...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://payuee.com/product_ca?page=${pageNumber}`;
}
...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="https://payuee.com/product_ca/${product.product_url_id}" class="product-link1">
                                <img loading="lazy" src="${product.Image1}" width="330" height="400" alt="${product.title}" class="pc__img product-img1">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://payuee.com/product_ca/${product.product_url_id}" class="product-link2">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://payuee.com/product_ca/${product.product_url_id}">${product.title}</a></h6>
                ${price}
                ...
                <a href="https://payuee.com/product_ca/${product.product_url_id}" class="pc__btn-wl-wrapper">
    ...
    imgWrapper.addEventListener('click', function(event) {
        ...
        window.location.href = `https://payuee.com/product_ca/${product.product_url_id}`;
    });
