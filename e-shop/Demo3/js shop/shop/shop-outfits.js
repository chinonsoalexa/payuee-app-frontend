...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://payuee.com/shop-outfits?page=${pageNumber}`;
}
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="https://payuee.com/shop-outfits/${product.product_url_id}" class="product-link1">
                                <img loading="lazy" src="${product.Image1}" width="330" height="400" alt="${product.title}" class="pc__img product-img1">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://payuee.com/shop-outfits/${product.product_url_id}" class="product-link2">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://payuee.com/shop-outfits/${product.product_url_id}">${product.title}</a></h6>
                ${price}
...
var products = [
    {
        ...
        "net_weight": 100,
        "product_stock": 0,
        "Image1": "../images/products/product_1.jpg",
        "Image2": "../images/products/product_1-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 200,
        "product_stock": 0,
        "Image1": "../images/products/product_2.jpg",
        "Image2": "../images/home/demo9/product_2-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 50,
        "product_stock": 5,
        "Image1": "../images/home/demo9/product_3.jpg",
        "Image2": "../images/products/product_3-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 300,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_4.jpg",
        "Image2": "../images/products/product_4-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 250,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_5.jpg",
        "Image2": "../images/products/product_5-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 500,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_6.jpg",
        "Image2": "../images/products/product_6-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 0,
        "Image1": "../images/home/demo9/product_7.jpg",
        "Image2": "../images/products/product_7-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_8.jpg",
        "Image2": "../images/products/product_8-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 200,
        "Image1": "../images/products/product_10.jpg",
        "Image2": "../images/products/product_10-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_11.jpg",
        "Image2": "../images/products/product_11-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_12.jpg",
        "Image2": "../images/products/product_12-1.jpg",
    ...
    },
    {
        ...
        "net_weight": 100,
        "product_stock": 200,
        "Image1": "../images/home/demo9/product_13.jpg",
        "Image2": "../images/products/product_13-1.jpg",
