...
async function getProduct(productID) {
    renderLoadingDetails();
  const apiUrl = "https://api.payuee.com/product/" + productID + "/outfit";
...
function updateCartDrawer() {
  ...
  if (cart.length === 0) {
      ...
      cart.forEach(cartProduct => {
          ...
          cartItem.innerHTML = `
              <div class="position-relative">
                <img loading="lazy" class="cart-drawer-item__img" src="/e-shop/Demo3/js-shop/product-details/${"https://payuee.com/image/"+cartProduct.product_image[0].url}" alt="">
              </div>
              <div class="cart-drawer-item__info flex-grow-1">
