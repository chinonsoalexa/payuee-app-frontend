  ...
  function renderStores(stores) {
    ...
    stores.forEach(store => {
        ...
        rowElement.innerHTML = `
            ...
            <p>${store.shop_state}, ${store.shop_city}<br>${store.shop_address}<br>Nigeria<br>${store.shop_phone}<br>${store.shop_email}<br>Open, ${store.open_days} days a week</p>
            <a id="store_selector_${store.userID}" href="shop-vendor.html/${store.store_unique_url}">Visit Store</a>
        `;
