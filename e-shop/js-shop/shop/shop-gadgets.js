...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://payuee.com/e-shop/shop-gadgets?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://payuee.com/e-shop/shop-gadgets?page=${CurrentPageOnLoad-1}`;
