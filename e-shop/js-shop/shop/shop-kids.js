...
async function getProducts() {
    ...
    try {
        ...
        if (!responseData.success || Object.keys(responseData.success).length === 0) {
            ...
            emptyMessage.innerHTML = `
                <div class="no-products-container">
                    ...
                    <h2 class="no-products-title">Be the First Vendor in Your Area (Kids Outfits)!</h2>
                    ...
                    <a href="https://app.payuee.com/e-shop/pricing" class="btn btn-primary btn-lg mt-3">Become a Vendor Now</a>
                </div>
            `;
        ...
        nextPageButtonI.href = `https://app.payuee.com/e-shop/shop-kids?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://app.payuee.com/e-shop/shop-kids?page=${CurrentPageOnLoad-1}`;
...
function redirectToShop(storeId) {
    const url = `https://app.payuee.com/store/${storeId}`; // Customize the URL as needed
...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://app.payuee.com/e-shop/shop-kids?page=${pageNumber}`;
}
...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://app.payuee.com/kids/${product.product_url_id}">${product.title}</a></h6>
                ${price}
    ...
    imgWrapper.addEventListener('click', function(event) {
        ...
        window.location.href = `https://app.payuee.com/kids/${product.product_url_id}`;
    });
