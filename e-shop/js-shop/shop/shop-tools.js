...
async function getProducts() {
    ...
    try {
        ...
        if (!responseData.success || Object.keys(responseData.success).length === 0) {
            ...
            emptyMessage.innerHTML = `
                <div class="no-products-container">
                    ...
                    <h2 class="no-products-title">Be the First Vendor in Your Area (Tools)!</h2>
        ...
        nextPageButtonI.href = `https://app.payuee.com/e-shop/shop-tools?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://app.payuee.com/e-shop/shop-tools?page=${CurrentPageOnLoad-1}`;
...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://app.payuee.com/e-shop/shop-tools?page=${pageNumber}`;
}
...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://app.payuee.com/tools/${product.product_url_id}">${product.title}</a></h6>
                ${price}
    ...
    imgWrapper.addEventListener('click', function(event) {
        ...
        window.location.href = `https://app.payuee.com/tools/${product.product_url_id}`;
    });
