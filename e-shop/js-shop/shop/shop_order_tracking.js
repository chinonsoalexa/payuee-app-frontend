...
// js button code:
 const fabContainer = document.getElementById("fabOrders");
    const fabBtn = document.getElementById("viewOrdersBtn");
    ...
    fabBtn.addEventListener("click", () => {
        window.open("https://payuee.com/e-shop/account_orders", "_blank");
    });
