        ...
        results.forEach(item => {
            ...
            const imageUrl = item.product_image?.[0]?.url
                ...
                if (item.category == "outfits") {
                    url = "https://payuee.com/outfits/v/" + item.product_url_id;
                } else if (item.category == "jewelry") {
                    url = "https://payuee.com/jewelry/v/" + item.product_url_id;
                } else if (item.category == "kids-accessories") {
                    url = "https://payuee.com/kids/v/" + item.product_url_id;
                } else if (item.category == "cars-car-parts") {
                    url = "https://payuee.com/cars/v/" + item.product_url_id;
                } else if (item.category == "tools") {
                    url = "https://payuee.com/tools/v/" + item.product_url_id;
                } else if (item.category == "gadgets") {
                    url = "https://payuee.com/gadgets/v/" + item.product_url_id;
