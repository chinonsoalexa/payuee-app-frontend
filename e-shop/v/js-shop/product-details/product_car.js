...
async function getProduct(productID) {
  const apiUrl = "https://api.payuee.com/open/product/" + productID;
          ...
          <div class="sticky-content">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
              ...
              <div class="product-single__prev-next d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                <a id="previousDetail" href="/e-shop/product11_v6.html" class="text-uppercase fw-medium"><svg class="mb-1px" width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><use href="#icon_prev_md" /></svg><span class="menu-link menu-link_us-s">Prev</span></a>
                <a id="nextDetail" href="/e-shop/product13_v8.html" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg class="mb-1px" width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_md" /></svg></a>
              </div><!-- /.shop-acs -->
            </div>
            ...
            <div class="product-single__addtolinks">
              ...
              <script src="/e-shop/js/details-disclosure.js" defer="defer"></script>
              <script src="/e-shop/js/share.js" defer="defer"></script>
            </div>
...
function renderRecommendedProduct(products) {
  ...
  products.forEach((product) => {
    ...
    if (product.category == "outfits") {
        urll = "https://app.payuee.com/outfits/v/" + product.product_url_id;
    } else if (product.category == "jewelry") {
        urll = "https://app.payuee.com/jewelry/v/" + product.product_url_id;
    } else if (product.category == "kids-accessories") {
        urll = "https://app.payuee.com/kids/v/" + product.product_url_id;
    } else if (product.category == "cars-car-parts") {
        urll = "https://app.payuee.com/cars/v/" + product.product_url_id;
    } else if (product.category == "tools") {
        urll = "https://app.payuee.com/tools/v/" + product.product_url_id;
    } else if (product.category == "gadgets") {
        urll = "https://app.payuee.com/gadgets/v/" + product.product_url_id;
