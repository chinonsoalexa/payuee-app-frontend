...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-car?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-car?page=${CurrentPageOnLoad-1}`;
...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://app.payuee.com/e-shop/v/shop-car?page=${pageNumber}`;
}
