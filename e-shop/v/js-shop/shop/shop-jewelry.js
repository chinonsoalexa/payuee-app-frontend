...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://payuee.com/e-shop/shop-jewelry?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://payuee.com/e-shop/shop-jewelry?page=${CurrentPageOnLoad-1}`;
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://payuee.com/jewelry/v/${product.product_url_id}">${product.title}</a></h6>
                ${price}
