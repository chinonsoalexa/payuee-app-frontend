...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-kids?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-kids?page=${CurrentPageOnLoad-1}`;
...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://app.payuee.com/outfits/v/${product.product_url_id}">${product.title}</a></h6>
                ${price}
    ...
    imgWrapper.addEventListener('click', function(event) {
        ...
        window.location.href = `https://app.payuee.com/outfits/v/${product.product_url_id}`;
    });
    ...
    if (!isOutOfStock) {
        ...
        addToCartButton.addEventListener('click', function(event) {
                ...
                if (product.clothing_sizes !== "" && product.shoes_sizes !== "") {
                    ...
                    window.location.href = `https://app.payuee.com/kids/v/${product.product_url_id}`;
                    return;
                }
            addToCart(product);
            updateCartNumber();
...
function redirectToShop(storeId) {
    const url = `https://app.payuee.com/e-shop/store/v/${storeId}`; // Customize the URL as needed
...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://app.payuee.com/e-shop/v/shop-kids?page=${pageNumber}`;
}
