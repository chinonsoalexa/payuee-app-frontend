...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-outfits?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://app.payuee.com/e-shop/v/shop-outfits?page=${CurrentPageOnLoad-1}`;
