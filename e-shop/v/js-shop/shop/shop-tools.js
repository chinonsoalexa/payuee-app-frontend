...
async function getProducts() {
    ...
    try {
        ...
        nextPageButtonI.href = `https://payuee.com/e-shop/shop-tools?page=${CurrentPageOnLoad+1}`;
        let previousPageButtonI = document.getElementById('previousPage');
        previousPageButtonI.href = `https://payuee.com/e-shop/shop-tools?page=${CurrentPageOnLoad-1}`;
...
function redirectToShop(storeId) {
    const url = `https://payuee.com/v/shop_vendor/${storeId}`; // Customize the URL as needed
...
function updateLink(urlIdToUpdate, pageNumber) {
        urlIdToUpdate.href = `https://payuee.com/e-shop/shop-tools?page=${pageNumber}`;
}
...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="https://payuee.com/tools/v/${product.product_url_id}">${product.title}</a></h6>
                ${price}
    ...
    imgWrapper.addEventListener('click', function(event) {
        ...
        window.location.href = `https://payuee.com/tools/v/${product.product_url_id}`;
    });
