...
function renderProducts(product) {
    ...
    rowElement.innerHTML = `
        <div class="prooduct-details-box">                                 
            <div class="d-flex"><img class="align-self-center img-fluid img-60" src="${"https://payuee.com/image/"+product.product_orders[0].product_image[0].url}" alt="${product.product_orders[0].title}" onerror="this.src='https://via.placeholder.com/60';">
